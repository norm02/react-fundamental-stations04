...
var SkillDescriptionContainer = st.div(SkillContents_templateObject3 || (SkillContents_templateObject3 = SkillContents_taggedTemplateLiteral(["\n  width: 60%;\n  font-size: 1.5rem;\n  margin: 2rem 0;\n  display: flex;\n  align-items: center;\n"])));
var SkillListContainer = st.div(SkillContents_templateObject4 || (SkillContents_templateObject4 = SkillContents_taggedTemplateLiteral(["\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n"])));
var SkillList = st.ul(_templateObject5 || (_templateObject5 = SkillContents_taggedTemplateLiteral(["\n  list-style: none;\n  margin: 0;\n  padding: 0;\n"])));
var SkillListItem = st.li(_templateObject6 || (_templateObject6 = SkillContents_taggedTemplateLiteral(["\n  margin-left: 0.2rem;\n  margin-bottom: 0.5rem;\n"])));
...
var LinkDescriptionContainer = st.div(LinkContents_templateObject3 || (LinkContents_templateObject3 = LinkContents_taggedTemplateLiteral(["\n  width: 60%;\n  font-size: 1.5rem;\n  margin-top: 2rem;\n  margin-bottom: 2rem;\n"])));
